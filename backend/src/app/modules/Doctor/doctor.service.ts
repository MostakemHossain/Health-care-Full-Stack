...
const getASingleDoctor = async (id: string): Promise<Doctor | null> => {
...
const updateADoctor = async (id: string, payload: any) => {
...
const deleteADoctor = async (id: string): Promise<Doctor> => {
